...
function is_junk_title(string $title): bool {
    ...
    $junkPatterns = [
        ...
        // Confirmed on production (2026-08-17): a "correctly finds no
        // subject match" result from classify_subjects() (verified working
        // by that point) still left junk sitting in General, since none of
        // this ever was a classification problem -- these are pages with
        // no article behind them at all, so no taxonomy could ever
        // legitimately tag them. 'journal metrics' catches usage/citation
        // stat pages (e.g. "Journal Metrics | Nature"); 'funding and
        // tenders' catches an EU portal's grant-listing page; 'official
        // website' (English) and 'επίσημος ιστότοπος' (Greek, the same
        // phrase) catch government/institutional portal homepages the same
